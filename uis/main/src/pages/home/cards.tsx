  ...
  return (
    <div className="flex flex-col items-center gap-4 mt-15 md:gap-6 px-4 md:px-6">
      ...
      <div className="w-full max-w-[1272px]">
        ...
        >
          ...
          <div className="w-full md:w-1/2 flex-shrink-0 flex justify-center">
            <img
              src={engine}
              alt="Engine"
              className="rounded-sm w-full max-w-[636px] h-auto object-cover"
            />
          </div>

          {/* Grid */}
          <div className="w-full md:w-1/2 flex-shrink-0 grid grid-cols-3 gap-1 xs:gap-2 sm:gap-3 justify-items-center max-w-[636px]">
            {cardData.map((item) => (
              <div
                key={item.id}
        ...
        {/* Explore Button */}
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 w-full justify-center mt-6 px-6 sm:px-0">
          <Link
            to="./products"
