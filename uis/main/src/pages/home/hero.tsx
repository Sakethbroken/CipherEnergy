...
const Hero = () => {
  ...
  <div ref={(el) => (linesRef.current[0] = el!)} className="opacity-0">
  ...
  <div ref={(el) => (linesRef.current[1] = el!)} className="opacity-0">
    <span className="worksans text-white font-medium text-[28px] sm:text-[32px] md:text-[48px] lg:text-[64px] tracking-[-0.02em]">
      Electric Motors for India’s
    </span>
  </div>

  <div ref={(el) => (linesRef.current[2] = el!)} className="opacity-0">
    <span className="worksans text-white font-medium text-[28px] sm:text-[32px] md:text-[48px] lg:text-[64px] tracking-[-0.02em]">
      Energy
    </span>{" "}
