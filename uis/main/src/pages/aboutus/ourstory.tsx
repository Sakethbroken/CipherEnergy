  ...
  return (
   ...
   <h2 className="playfair bg-gradient-to-r from-white to-[#074FF7] bg-clip-text text-transparent text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold italic text-center  ">
        ...
        {/* First Card */}
          ...
          {/* Text Section */}
          <div className="flex  md:flex-row items-center gap-[64px]">

          <div className=" flex items-center w-[476px] ">
          ...
          {/* Image Section */}
          <div className="w-full max-w-[468px] md:w-1/2 flex justify-center">
            <img
              src={indmap}
              alt="Map of India"
