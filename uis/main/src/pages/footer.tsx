    ...
    <div className="relative w-full bg-gradient-to-b from-[#074FF7] to-[#020919] text-white">
      <div className="max-w-[1340px] pt-10 flex flex-col md:flex-row justify-between mx-auto px-4 sm:px-6">
        <div className="grid w-full md:w-[544px] grid-cols-2 sm:grid-cols-4 gap-3 text-white text-sm mb-8 md:mb-0">
         ...
         <Link to="/cem1" className="text-left hover:text-blue-300 cursor-pointer">CEM1</Link>
<Link to="/cem2" className="text-left hover:text-blue-300 cursor-pointer">CEM2</Link>
<Link to="/cem3" className="text-left hover:text-blue-300 cursor-pointer">CEM3</Link>
<Link to="/cem4" className="text-left hover:text-blue-300 cursor-pointer">CEM4</Link>
<Link to="/cem5" className="text-left hover:text-blue-300 cursor-pointer">CEM5</Link>
